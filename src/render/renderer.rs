...
impl Renderer {
    ...
    fn bg_pal(ppu: &PPU, tile_column: usize, tile_row : usize) -> [u8; 4] {
        ...
        [ppu.palette[0], ppu.palette[pallete_start], ppu.palette[pallete_start + 1], ppu.palette[pallete_start + 2]]
    }
